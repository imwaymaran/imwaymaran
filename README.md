...
- I build projects that combine data, code, and impact
...
Evaluation of wellbeing outcomes for 10K+ youth through modeling and visual analysis to support funding decisions and program improvements.
The core analysis is complete; current work focuses on preparing final documentation for the client.  
...
**[Mental Health Chatbot](https://github.com/imwaymaran/mh-support-chatbot)**  
Gemini-powered wellness assistant with appointment simulation, reminders, and crisis detection.  
*Tools: Python, Gemini API*

**[Suicide Ideation Detection](https://github.com/imwaymaran/suicide-ideation-detection-ml)**  
